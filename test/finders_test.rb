...
describe '.string' do
  ...
  describe '#find_' do
    it 'finds a unique element when passed a string' do
      string.find_row('Peas').text.must_have_content 'Peas'
      string.find_row('Peas').text.wont_have_content 'Dogs'
      string.find_table('Peas').text.must_have_content 'Peas'
    ...
    #describe 'passing a hash' do
      #it 'finds a unique element when passed its class' do
        #string.find_row({ class: 'animal' }).text.must_have_content 
      #end
